...
app.secret_key = "rodrigovp2"

# Configuración de MongoDB Atlas
client = MongoClient("mongodb+srv://dressierartist8:DerEisendrache8@cluster0.sbbsr4f.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = client['db1'] #Nombre de tu base de datos aquí
collection = db['usuarios'] #Nombre de tu colección aquí

# Configuración de SendGrid
SENDGRID_API_KEY = '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' 
...
def enviar_email(destinatario, asunto, cuerpo):
    mensaje = Mail(
        from_email='dressierartist8@gmail.com',  # Cambia esto por tu correo
...
@app.route('/catalogo')
def catalogo():
    # Aquí puedes agregar lógica si es necesario, como verificar la sesión
    # ...
